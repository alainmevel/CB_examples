...
******************************************************/
	...
	faults_openedSensorFault = self.Bool + 4;
	faults_closedSensorFault = self.Bool + 5;
...
label3:	/* Discordance fault */
	if((ton_ms_3_Q = ton_ms_Q((openedSensorFB & closedSensorFB), presetDiscordance, &ton_ms_3_i_tonms, &ton_ms_3_t1_tonms, &ton_ms_3_t2_tonms))) {
		discordanceFault = 1;
	}
label4:	/* General fault */
	if((discordanceFault | (openedSensorFault | closedSensorFault))) {
		generalFault = 1;
	}
