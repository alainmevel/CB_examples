...
#define mx_acces_cmd_equipment_library__faults__ton_sec_3_i_ton Int[6].CB_current_value
#define mx_acces_cmd_equipment_library__faults__ton_sec_3_t1_ton Float[2].CB_current_value
#define mx_acces_cmd_equipment_library__faults__ton_sec_3_t2_ton Int[7].CB_current_value
#define mx_acces_cmd_equipment_library__faults__ton_sec_3_Q Bool[2].CB_current_value
#define mx_acces_cmd_equipment_library__faults__ton_sec_3_CV Int[8].CB_current_value
#define mx_acces_cmd_equipment_library__faults__preset Int[9].CB_current_value
#define mx_acces_cmd_equipment_library__faults__thermalFault Bool[3].CB_current_value
#define mx_acces_cmd_equipment_library__faults__highSpeedFBFault Bool[4].CB_current_value
#define mx_acces_cmd_equipment_library__faults__lowSpeedFBFault Bool[5].CB_current_value
