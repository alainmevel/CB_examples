...
static CB_Mem_Bool *defaults_cmdOut;
static CB_Mem_Bool *defaults_cmdIn;
static CB_Mem_Bool *defaults_pbAcknowledgement;
static CB_Mem_Bool *defaults_sensorOut;
static CB_Mem_Bool *defaults_sensorIn;
...
static CB_Mem_Bool *defaults_defaultGoingOut;
static CB_Mem_Bool *defaults_defaultComingIn;
...
/*****************************************************
                             Variables
******************************************************/
#define cmdOut (defaults_cmdOut->CB_previous_value)		/* Command of going out */
#define cmdIn (defaults_cmdIn->CB_previous_value)		/* Command of coming in */
#define pbAcknowledgement (defaults_pbAcknowledgement->CB_previous_value)		/* Acknowledgement pushbutton */
#define sensorOut (defaults_sensorOut->CB_previous_value)
#define sensorIn (defaults_sensorIn->CB_previous_value)
...
#define defaultGoingOut (defaults_defaultGoingOut->CB_current_value)		/* Default of going out */
#define defaultComingIn (defaults_defaultComingIn->CB_current_value)		/* Default of coming in */
...
******************************************************/
	...
	defaults_defaultGoingOut = self.Bool+4;
	defaults_defaultComingIn = self.Bool+5;
...
label2:	/* Default of movements */
	if(((ton_sec_1_Q = ton_sec_Q(cmdOut, presetMvt, &ton_sec_1_i_ton, &ton_sec_1_t1_ton, &ton_sec_1_t2_ton)) & !sensorOut)) {
		defaultGoingOut = 1;
	}
	if(((ton_sec_2_Q = ton_sec_Q(cmdIn, presetMvt, &ton_sec_2_i_ton, &ton_sec_2_t1_ton, &ton_sec_2_t2_ton)) & !sensorIn)) {
		defaultComingIn = 1;
	}
label3:	/* Default of discordance */
	if((ton_ms_3_Q = ton_ms_Q((sensorOut & sensorIn), presetDisc, &ton_ms_3_i_tonms, &ton_ms_3_t1_tonms, &ton_ms_3_t2_tonms))) {
		defaultSensors = 1;
	}
label4:	/* Default general */
	if((defaultSensors | (defaultGoingOut | defaultComingIn))) {
		defaultGeneral = 1;
	}
...
#undef defaultGoingOut
#undef defaultComingIn
