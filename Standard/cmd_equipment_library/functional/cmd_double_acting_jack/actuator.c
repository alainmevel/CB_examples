...
label1:	/* Work command */
	workCmd = ((((((autoMode & autoWorkCmd) | (autoMode & workCmd)) & !autoRestCmd) | (((manualMode & valveWorkPB) & !valveRestPB) | (manualMode & workCmd))) & !outletSensor) & !generalFault);
label2:	/* Rest command */
	restCmd = ((((((autoMode & autoRestCmd) | (autoMode & restCmd)) & !autoWorkCmd) | (((manualMode & valveRestPB) & !valveWorkPB) | (manualMode & restCmd))) & !inletSensor) & !generalFault);
