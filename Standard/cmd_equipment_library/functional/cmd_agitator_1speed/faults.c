...
static CB_Mem_Bool *faults_cmdFB;
...
static CB_Mem_Bool *faults_cmdFBFault;
...
/*****************************************************
                             Variables
******************************************************/
#define cmd (faults_cmd->CB_previous_value)		/* Command of the agitator */
#define thermalFB (faults_thermalFB->CB_previous_value)		/* Feedback of the thermal protection of the agitator */
#define cmdFB (faults_cmdFB->CB_previous_value)		/* Command feedback */
...
#define cmdFBFault (faults_cmdFBFault->CB_current_value)		/* Command feedback fault */
...
label2:	/* Fault of forward feedback */
	if(((ton_sec_1_Q = ton_sec_Q(cmd, preset, &ton_sec_1_i_ton, &ton_sec_1_t1_ton, &ton_sec_1_t2_ton)) & !cmdFB)) {
		cmdFBFault = 1;
	}
