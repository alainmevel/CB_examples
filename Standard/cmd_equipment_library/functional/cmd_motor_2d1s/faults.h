...
#define mx_acces_cmd_equipment_library__faults__forwardFBFault Bool[4].CB_current_value
#define mx_acces_cmd_equipment_library__faults__backwardFBFault Bool[5].CB_current_value
