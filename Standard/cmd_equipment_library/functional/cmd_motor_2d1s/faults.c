...
label2:	/* Faults of forward and backward feedbacks */
	if(((ton_sec_1_Q = ton_sec_Q(forwardCmd, preset, &ton_sec_1_i_ton, &ton_sec_1_t1_ton, &ton_sec_1_t2_ton)) & !forwardFB)) {
		forwardFBFault = 1;
	}
	if(((ton_sec_2_Q = ton_sec_Q(backwardCmd, preset, &ton_sec_2_i_ton, &ton_sec_2_t1_ton, &ton_sec_2_t2_ton)) & !backwardFB)) {
		backwardFBFault = 1;
	}
