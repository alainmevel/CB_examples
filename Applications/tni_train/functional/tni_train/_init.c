...
#include "tni_train/functional/tni_train/tni_train.h"
...
int behaviorsInit(void)
{
	...
	tni_train__num = self_num;
	inputOutputVariablesInit();
	_tni_train__tni_train_init();
...
void variablesInitialization(void)
{
	...
	CB_Char_Init((char *) memHeader, 0 + 8, 'r');
	...
	CB_Bool_Init((char *) memHeader, 110, 1); /*cab1/cabControlPart/keyCabDisabled*/
	CB_Bool_Init((char *) memHeader, 112, 1); /*cab1/cabControlPart/leftServiceSide*/
	CB_Bool_Init((char *) memHeader, 130, 1); /*cab2/cabControlPart/keyCabDisabled*/
	CB_Bool_Init((char *) memHeader, 132, 1); /*cab2/cabControlPart/leftServiceSide*/
}
