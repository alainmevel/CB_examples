...
/********************************************************************
 *            Public 'copie_batch.syrup' implementation             *
 ********************************************************************/

#include "syrup.h"
#include "equipment_library/functional/flow_compute/flow_compute.h"
#include "copie_batch/functional/syrup_weighing/syrup_weighing.h"
#include "io_library/functional/io_on_off_valve/io_on_off_valve.h"
#include "copie_batch/functional/add_syrup/add_syrup.h"
...
static CB_Offset copie_batch__syrup_offset_flow;
static CB_Offset copie_batch__syrup_offset_syrupManagement;
static CB_Offset copie_batch__syrup_offset_arrivalValveSyrup1;
static CB_Offset copie_batch__syrup_offset_arrivalValveSyrup2;
static CB_Offset copie_batch__syrup_offset_arrivalValveSyrup3;
static CB_Offset copie_batch__syrup_offset_syrupExtractionValve;
static CB_Offset copie_batch__syrup_offset_faults1;
static CB_Offset copie_batch__syrup_offset_syrupQuantity;
static CB_Offset copie_batch__syrup_offset_syrupsTank;
static CB_Offset copie_batch__syrup_offset_level;
static CB_Offset copie_batch__syrup_offset_scale;
static CB_Offset copie_batch__syrup_offset__end = {0, 0, 0, 0};


/********************* Initialization function **********************/

int _copie_batch__syrup_init(void)
{
	...
	self_num++;
	copie_batch__syrup_offset_flow.Bool = self.Bool - __start.Bool;
	copie_batch__syrup_offset_flow.Int = self.Int - __start.Int;
	copie_batch__syrup_offset_flow.Float = self.Float - __start.Float;
	copie_batch__syrup_offset_flow.Char = self.Char - __start.Char;
	...
	/*initialize child syrupManagement (copie_batch.syrup_weighing):*/
	self_num++;
	copie_batch__syrup_offset_syrupManagement.Bool = self.Bool - __start.Bool;
	copie_batch__syrup_offset_syrupManagement.Int = self.Int - __start.Int;
	copie_batch__syrup_offset_syrupManagement.Float = self.Float - __start.Float;
	copie_batch__syrup_offset_syrupManagement.Char = self.Char - __start.Char;
	...
	_copie_batch__syrup_weighing_init();

	/*initialize child arrivalValveSyrup1 (io_library.io_on_off_valve):*/
	self_num++;
	copie_batch__syrup_offset_arrivalValveSyrup1.Bool = self.Bool - __start.Bool;
	copie_batch__syrup_offset_arrivalValveSyrup1.Int = self.Int - __start.Int;
	copie_batch__syrup_offset_arrivalValveSyrup1.Float = self.Float - __start.Float;
	copie_batch__syrup_offset_arrivalValveSyrup1.Char = self.Char - __start.Char;
	...
	self_num++;
	copie_batch__syrup_offset_arrivalValveSyrup2.Bool = self.Bool - __start.Bool;
	copie_batch__syrup_offset_arrivalValveSyrup2.Int = self.Int - __start.Int;
	copie_batch__syrup_offset_arrivalValveSyrup2.Float = self.Float - __start.Float;
	copie_batch__syrup_offset_arrivalValveSyrup2.Char = self.Char - __start.Char;
	io_on_off_valve_acknowledgePB = syrup_acknowledgePB;
	io_on_off_valve_autoMode = syrup_autoMode;
	io_on_off_valve_manualMode = syrup_manualMode;
	...
	self_num++;
	copie_batch__syrup_offset_arrivalValveSyrup3.Bool = self.Bool - __start.Bool;
	copie_batch__syrup_offset_arrivalValveSyrup3.Int = self.Int - __start.Int;
	copie_batch__syrup_offset_arrivalValveSyrup3.Float = self.Float - __start.Float;
	copie_batch__syrup_offset_arrivalValveSyrup3.Char = self.Char - __start.Char;
	io_on_off_valve_acknowledgePB = syrup_acknowledgePB;
	io_on_off_valve_autoMode = syrup_autoMode;
	io_on_off_valve_manualMode = syrup_manualMode;
	...
	self_num++;
	copie_batch__syrup_offset_syrupExtractionValve.Bool = self.Bool - __start.Bool;
	copie_batch__syrup_offset_syrupExtractionValve.Int = self.Int - __start.Int;
	copie_batch__syrup_offset_syrupExtractionValve.Float = self.Float - __start.Float;
	copie_batch__syrup_offset_syrupExtractionValve.Char = self.Char - __start.Char;
	io_on_off_valve_acknowledgePB = syrup_acknowledgePB;
	io_on_off_valve_autoMode = syrup_autoMode;
	io_on_off_valve_manualMode = syrup_manualMode;
	...
	self_num++;
	copie_batch__syrup_offset_faults1.Bool = self.Bool - __start.Bool;
	copie_batch__syrup_offset_faults1.Int = self.Int - __start.Int;
	copie_batch__syrup_offset_faults1.Float = self.Float - __start.Float;
	copie_batch__syrup_offset_faults1.Char = self.Char - __start.Char;
	...
	/*initialize child syrupQuantity (copie_batch.add_syrup):*/
	self_num++;
	copie_batch__syrup_offset_syrupQuantity.Bool = self.Bool - __start.Bool;
	copie_batch__syrup_offset_syrupQuantity.Int = self.Int - __start.Int;
	copie_batch__syrup_offset_syrupQuantity.Float = self.Float - __start.Float;
	copie_batch__syrup_offset_syrupQuantity.Char = self.Char - __start.Char;
	...
	_copie_batch__add_syrup_init();

	/*initialize child syrupsTank (equipment_library.tank):*/
	self_num++;
	copie_batch__syrup_offset_syrupsTank.Bool = self.Bool - __start.Bool;
	copie_batch__syrup_offset_syrupsTank.Int = self.Int - __start.Int;
	copie_batch__syrup_offset_syrupsTank.Float = self.Float - __start.Float;
	copie_batch__syrup_offset_syrupsTank.Char = self.Char - __start.Char;
	...
	self_num++;
	copie_batch__syrup_offset_level.Bool = self.Bool - __start.Bool;
	copie_batch__syrup_offset_level.Int = self.Int - __start.Int;
	copie_batch__syrup_offset_level.Float = self.Float - __start.Float;
	copie_batch__syrup_offset_level.Char = self.Char - __start.Char;
	...
	self_num++;
	copie_batch__syrup_offset_scale.Bool = self.Bool - __start.Bool;
	copie_batch__syrup_offset_scale.Int = self.Int - __start.Int;
	copie_batch__syrup_offset_scale.Float = self.Float - __start.Float;
	copie_batch__syrup_offset_scale.Char = self.Char - __start.Char;
	...
	copie_batch__syrup_offset__end.Bool = self.Bool - __start.Bool;
	copie_batch__syrup_offset__end.Int = self.Int - __start.Int;
	copie_batch__syrup_offset__end.Float = self.Float - __start.Float;
	copie_batch__syrup_offset__end.Char = self.Char - __start.Char;
...
int copie_batch__syrup(void)
{
	...
	if (exec_mac_node(self_num)) {
		...
		{
			self.Bool = __start.Bool + copie_batch__syrup_offset_flow.Bool;
			self.Int = __start.Int + copie_batch__syrup_offset_flow.Int;
			self.Float = __start.Float + copie_batch__syrup_offset_flow.Float;
			self.Char = __start.Char + copie_batch__syrup_offset_flow.Char;
			...
			__ret = copie_batch__syrup_weighing();
			if (__ret != 0) {
				return __ret; /*child execution failure*/
			}
	...
	self.Bool = __start.Bool + copie_batch__syrup_offset__end.Bool;
	self.Int = __start.Int + copie_batch__syrup_offset__end.Int;
	self.Float = __start.Float + copie_batch__syrup_offset__end.Float;
	self.Char = __start.Char + copie_batch__syrup_offset__end.Char;
