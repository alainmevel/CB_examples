...
static CB_Offset copie_batch__mixture_offset_collectedMixture;
static CB_Offset copie_batch__mixture_offset_flow;
static CB_Offset copie_batch__mixture_offset_kneading;
static CB_Offset copie_batch__mixture_offset_motorOfAgitator;
static CB_Offset copie_batch__mixture_offset_cleaningValve;
static CB_Offset copie_batch__mixture_offset_mixtureExtractingValve;
static CB_Offset copie_batch__mixture_offset_mixtureWeighing;
static CB_Offset copie_batch__mixture_offset_faults1;
static CB_Offset copie_batch__mixture_offset_level;
static CB_Offset copie_batch__mixture_offset_scale;
static CB_Offset copie_batch__mixture_offset__end = {0, 0, 0, 0};


/********************* Initialization function **********************/

int _copie_batch__mixture_init(void)
{
	...
	/*initialize child collectedMixture (copie_batch.add_syrup):*/
	self_num++;
	copie_batch__mixture_offset_collectedMixture.Bool = self.Bool - __start.Bool;
	copie_batch__mixture_offset_collectedMixture.Int = self.Int - __start.Int;
	copie_batch__mixture_offset_collectedMixture.Float = self.Float - __start.Float;
	copie_batch__mixture_offset_collectedMixture.Char = self.Char - __start.Char;
	...
	self_num++;
	copie_batch__mixture_offset_flow.Bool = self.Bool - __start.Bool;
	copie_batch__mixture_offset_flow.Int = self.Int - __start.Int;
	copie_batch__mixture_offset_flow.Float = self.Float - __start.Float;
	copie_batch__mixture_offset_flow.Char = self.Char - __start.Char;
	...
	/*initialize child kneading (copie_batch.kneading):*/
	self_num++;
	copie_batch__mixture_offset_kneading.Bool = self.Bool - __start.Bool;
	copie_batch__mixture_offset_kneading.Int = self.Int - __start.Int;
	copie_batch__mixture_offset_kneading.Float = self.Float - __start.Float;
	copie_batch__mixture_offset_kneading.Char = self.Char - __start.Char;
	...
	_copie_batch__kneading_init();

	/*initialize child motorOfAgitator (io_library.io_agitator_1speed):*/
	self_num++;
	copie_batch__mixture_offset_motorOfAgitator.Bool = self.Bool - __start.Bool;
	copie_batch__mixture_offset_motorOfAgitator.Int = self.Int - __start.Int;
	copie_batch__mixture_offset_motorOfAgitator.Float = self.Float - __start.Float;
	copie_batch__mixture_offset_motorOfAgitator.Char = self.Char - __start.Char;
	...
	self_num++;
	copie_batch__mixture_offset_cleaningValve.Bool = self.Bool - __start.Bool;
	copie_batch__mixture_offset_cleaningValve.Int = self.Int - __start.Int;
	copie_batch__mixture_offset_cleaningValve.Float = self.Float - __start.Float;
	copie_batch__mixture_offset_cleaningValve.Char = self.Char - __start.Char;
	...
	self_num++;
	copie_batch__mixture_offset_mixtureExtractingValve.Bool = self.Bool - __start.Bool;
	copie_batch__mixture_offset_mixtureExtractingValve.Int = self.Int - __start.Int;
	copie_batch__mixture_offset_mixtureExtractingValve.Float = self.Float - __start.Float;
	copie_batch__mixture_offset_mixtureExtractingValve.Char = self.Char - __start.Char;
	io_on_off_valve_acknowledgePB = mixture_acknowledgePB;
	io_on_off_valve_autoMode = mixture_autoMode;
	io_on_off_valve_manualMode = mixture_manualMode;
	...
	self_num++;
	copie_batch__mixture_offset_mixtureWeighing.Bool = self.Bool - __start.Bool;
	copie_batch__mixture_offset_mixtureWeighing.Int = self.Int - __start.Int;
	copie_batch__mixture_offset_mixtureWeighing.Float = self.Float - __start.Float;
	copie_batch__mixture_offset_mixtureWeighing.Char = self.Char - __start.Char;
	...
	self_num++;
	copie_batch__mixture_offset_faults1.Bool = self.Bool - __start.Bool;
	copie_batch__mixture_offset_faults1.Int = self.Int - __start.Int;
	copie_batch__mixture_offset_faults1.Float = self.Float - __start.Float;
	copie_batch__mixture_offset_faults1.Char = self.Char - __start.Char;
	...
	self_num++;
	copie_batch__mixture_offset_level.Bool = self.Bool - __start.Bool;
	copie_batch__mixture_offset_level.Int = self.Int - __start.Int;
	copie_batch__mixture_offset_level.Float = self.Float - __start.Float;
	copie_batch__mixture_offset_level.Char = self.Char - __start.Char;
	...
	self_num++;
	copie_batch__mixture_offset_scale.Bool = self.Bool - __start.Bool;
	copie_batch__mixture_offset_scale.Int = self.Int - __start.Int;
	copie_batch__mixture_offset_scale.Float = self.Float - __start.Float;
	copie_batch__mixture_offset_scale.Char = self.Char - __start.Char;
	...
	copie_batch__mixture_offset__end.Bool = self.Bool - __start.Bool;
	copie_batch__mixture_offset__end.Int = self.Int - __start.Int;
	copie_batch__mixture_offset__end.Float = self.Float - __start.Float;
	copie_batch__mixture_offset__end.Char = self.Char - __start.Char;
...
int copie_batch__mixture(void)
{
	...
	if (exec_mac_node(self_num)) {
		...
		{
			self.Bool = __start.Bool + copie_batch__mixture_offset_collectedMixture.Bool;
			self.Int = __start.Int + copie_batch__mixture_offset_collectedMixture.Int;
			self.Float = __start.Float + copie_batch__mixture_offset_collectedMixture.Float;
			self.Char = __start.Char + copie_batch__mixture_offset_collectedMixture.Char;
	...
	self.Bool = __start.Bool + copie_batch__mixture_offset__end.Bool;
	self.Int = __start.Int + copie_batch__mixture_offset__end.Int;
	self.Float = __start.Float + copie_batch__mixture_offset__end.Float;
	self.Char = __start.Char + copie_batch__mixture_offset__end.Char;
