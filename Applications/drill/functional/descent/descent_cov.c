...
{
	static char *__comp_name = "drill.descent";
	if (exec_term_node(self_num)) {
...

		{
			...
			if (acknowledgePB_EDGE > 0) {
				cov_control_struct(__comp_name, self_num, INPRESFC, 2, IFTHEN);
				motorFault = 0;
			}
			else {
				cov_control_struct(__comp_name, self_num, INPRESFC, 2, IFELSE);
			}
			if ((_X_21 || _X_41) && equipmentFault) {
				cov_control_struct(__comp_name, self_num, INPRESFC, 5, IFTHEN);
				motorFault = 1;
			}
			else {
				cov_control_struct(__comp_name, self_num, INPRESFC, 5, IFELSE);
			}
			if ((_X_31 || _X_11) && equipmentFault) {
				cov_control_struct(__comp_name, self_num, INPRESFC, 8, IFTHEN);
				motorFault = 2;
			}
			else {
				cov_control_struct(__comp_name, self_num, INPRESFC, 8, IFELSE);
			}
			if ((_X_21 || _X_11) && equipmentFault) {
				cov_control_struct(__comp_name, self_num, INPRESFC, 11, IFTHEN);
				motorFault = 3;
			}
			else {
				cov_control_struct(__comp_name, self_num, INPRESFC, 11, IFELSE);
			}
			if ((_X_41 || _X_31) && equipmentFault) {
				cov_control_struct(__comp_name, self_num, INPRESFC, 14, IFTHEN);
				motorFault = 4;
			}
			else {
				cov_control_struct(__comp_name, self_num, INPRESFC, 14, IFELSE);
			}
			/*transitions G1*/
