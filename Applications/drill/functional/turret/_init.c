...
{
	turret_speed = self.Float;
	self.Float++;
	turret_forward = self.Bool;
	self.Bool++;
	turret_backward = self.Bool;
	self.Bool++;
	turret_highSpeed = self.Bool;
	self.Bool++;
	turret_lowSpeed = self.Bool;
	self.Bool++;
	turret_axlePosition = self.Float;
	self.Float++;
	turret_forwardEnd = self.Bool;
	self.Bool++;
	turret_forwardDeceleration = self.Bool;
	self.Bool++;
	turret_backwardDeceleration = self.Bool;
	self.Bool++;
	turret_backwardEnd = self.Bool;
	self.Bool++;
}
...
void variablesInitialization(void)
{
	...
	CB_Char_Init((char *) memHeader, 0 + 5, 'r');
	CB_Char_Init((char *) memHeader, 0 + 6, 'r');
	CB_Char_Init((char *) memHeader, 0 + 7, 'e');
	CB_Char_Init((char *) memHeader, 0 + 8, 't');
