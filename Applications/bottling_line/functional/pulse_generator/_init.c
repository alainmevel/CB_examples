...
{
	pulse_generator_speed = self.Float;
	self.Float++;
	pulse_generator_sensorSupply = self.Bool;
	self.Bool++;
	pulse_generator_pulseSensor = self.Bool;
	self.Bool++;
}
...
void variablesInitialization(void)
{
	...
	CB_Char_Init((char *) memHeader, 0 + 5, 'l');
	CB_Char_Init((char *) memHeader, 0 + 6, 's');
	CB_Char_Init((char *) memHeader, 0 + 7, 'e');
	CB_Char_Init((char *) memHeader, 0 + 8, '_');
	...
	CB_Char_Init((char *) memHeader, 0 + 14, 'a');
	CB_Char_Init((char *) memHeader, 0 + 15, 't');
	CB_Char_Init((char *) memHeader, 0 + 16, 'o');
	CB_Char_Init((char *) memHeader, 0 + 17, 'r');
