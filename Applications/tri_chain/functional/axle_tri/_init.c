...
{
	axle_tri_speed = self.Float;
	self.Float++;
	axle_tri_positionTranslat = self.Float;
	self.Float++;
	axle_tri_percentTranslat = self.Float;
	self.Float++;
	axle_tri_incTranslat = self.Float;
	self.Float++;
}
...
void variablesInitialization(void)
{
	...
	CB_Char_Init((char *) memHeader, 0 + 3, 'a');
	CB_Char_Init((char *) memHeader, 0 + 4, 'x');
	CB_Char_Init((char *) memHeader, 0 + 5, 'l');
	CB_Char_Init((char *) memHeader, 0 + 6, 'e');
	CB_Char_Init((char *) memHeader, 0 + 7, '_');
	CB_Char_Init((char *) memHeader, 0 + 8, 't');
	CB_Char_Init((char *) memHeader, 0 + 9, 'r');
