...
{
	motor1dir_1speed_forward = self.Bool;
	self.Bool++;
	motor1dir_1speed_cmdSupply = self.Bool;
	self.Bool++;
	motor1dir_1speed_sensorSupply = self.Bool;
	self.Bool++;
	motor1dir_1speed_voltage380 = self.Bool;
	self.Bool++;
	motor1dir_1speed_speedVal = self.Float;
	self.Float++;
	motor1dir_1speed_speedPercent = self.Float;
	self.Float++;
	motor1dir_1speed_thermal = self.Bool;
	self.Bool++;
	motor1dir_1speed_forwardFB = self.Bool;
	self.Bool++;
}
...
void variablesInitialization(void)
{
	...
	CB_Char_Init((char *) memHeader, 0 + 8, '1');
