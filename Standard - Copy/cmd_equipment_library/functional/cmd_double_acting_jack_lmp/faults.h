...
#define mx_acces_cmd_equipment_library__faults__outletSensorFault Bool[4].CB_current_value
#define mx_acces_cmd_equipment_library__faults__inletSensorFault Bool[5].CB_current_value
