...
/*****************************************************
                             Variables
******************************************************/
#define cmdOn (defaults_cmdOn->CB_previous_value)		/* Command of opening */
...
label2:	/* Default of movements */
	...
	if(((ton_sec_2_Q = ton_sec_Q(!cmdOn, presetMvt, &ton_sec_2_i_ton, &ton_sec_2_t1_ton, &ton_sec_2_t2_ton)) & !sensorOff)) {
		defaultOff = 1;
	}
