...
label1:	/* open command */
	openCmd = ((((manualMode & openCmd) | (((manualMode & openValvePB) & !closeValvePB) | (((autoMode & autoOpenCmd) | (autoMode & openCmd)) & !autoCloseCmd))) & !openedSensorFB) & !generalFault);
label2:	/* Close command */
	closeCmd = ((((manualMode & closeCmd) | (((manualMode & closeValvePB) & !openValvePB) | (((autoMode & autoCloseCmd) | (autoMode & closeCmd)) & !autoOpenCmd))) & !closedSensorFB) & !generalFault);
